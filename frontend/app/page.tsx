      ...
      <div className="container mx-auto px-4 py-24 relative">
        ...
        <div className="text-center max-w-3xl mx-auto relative z-10">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Your personal AI piano tutor that adapts to your learning style and
            helps you master the piano at your own pace.
          </p>
          <Button
            size="lg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="border-2 hover:border-[#8E44AD] transition-colors">
            <CardHeader>
              ...
              <CardDescription className="text-gray-600">
                Get instant feedback on your playing technique and accuracy.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-2 hover:border-[#8E44AD] transition-colors">
            <CardHeader>
              ...
              <CardDescription className="text-gray-600">
                AI adapts to your progress and creates custom practice sessions.
              </CardDescription>
            </CardHeader>
          </Card>
        ...
        <Card className="bg-[#F39C12] text-white border-0">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-white/90 mb-8 max-w-2xl mx-auto">
              Join thousands of students who are learning piano with our AI
              tutor. Start your free trial today!
            </p>
            <Button
              size="lg"
              variant="outline"
              className="bg-white text-[#F39C12] hover:text-[#F39C12]"
            >
              Try for Free
            </Button>
          </CardContent>
