  ...
  const convertToVexFlowNote = (note: string | null): string => {
    ...
    try {
      ...
      const isStandardAccidentalPattern =
        note.length === 3 && (note.charAt(1) === "F" || note.charAt(1) === "S");
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (currentNote) {
        ...
        const hasFlat =
          currentNote.length === 3 && currentNote.charAt(1) === "b";
        const hasCustomFlat =
          currentNote.length === 3 && currentNote.charAt(1) === "F";
        const hasSharp =
          currentNote.length === 3 && currentNote.charAt(1) === "#";
        const hasCustomSharp =
          currentNote.length === 3 && currentNote.charAt(1) === "S";
        ...
        new Formatter()
          .joinVoices([voice])
          .format([voice], containerWidth - 100);
      ...
      errorMessage.textContent =
        "Could not render staff. Check console for errors.";
